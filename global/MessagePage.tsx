...
//         {/* Sidebar */}
//         <aside className="w-64 border-r border-cyan-100 py-6 pr-4 bg-cyan-50">
//           <div className="mb-4 px-4 font-bold text-cyan-800">Chats</div>
//           <ul>
//             {connections.map((u) => (
//               <li
//                 key={u._id}
//                 onClick={() => setActiveChat(u)}
//                 className={`flex items-center px-4 py-3 rounded-lg mb-2 cursor-pointer transition ${
//                   activeChat?._id === u._id ? "bg-cyan-200 font-semibold" : "hover:bg-cyan-100"
//                 }`}
//               >
//                 <img className="w-8 h-8 rounded-full mr-3" src={u.profilePhoto || "/default-avatar.png"} alt="" />
