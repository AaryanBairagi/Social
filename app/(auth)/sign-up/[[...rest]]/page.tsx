    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#e0f2fe] via-[#fff] to-[#a5f3fc] p-8">
      {/* IMAGE CARD WITH HEADING OVERLAID */}
        ...
        <div className="absolute w-full left-0 top-0 flex flex-col items-center px-0 pt-10 pb-2 z-20">
            <div className="px-5 py-2 rounded-2xl bg-white/80 backdrop-blur-3xl">
                ...
                <p className="text-gray-700 text-base md:text-lg font-medium text-center max-w-lg mx-auto mt-1">
                    Welcome! Join your campus network, <span className="text-cyan-600 font-semibold">connect</span> and unlock <span className="text-cyan-600 font-semibold">exclusive student features</span>.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div className="bg-white/20 rounded-2xl shadow-lg p-1 flex justify-center backdrop-blur-sm min-h-[600px] max-h-[700px]">
                <SignUp
                appearance={{
                    elements: {
