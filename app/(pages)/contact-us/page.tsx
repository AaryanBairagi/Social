  ...
  return (
    <div className="max-w-5xl mx-auto my-20 p-8 rounded-3xl hover:shadow-[0_0_20px_3px_rgba(6,182,212,0.8),0_8px_32px_0_rgba(6,182,212,0.28)] transition-shadow duration-300 ease-in-out border-1 hover:border-cyan-300 bg-cyan-100/30  border-cyan-100">
      ...
      <p className="mb-8 text-gray-700 max-w-xl">
        Need assistance? <br/> Our dedicated support team at your college <br/> (email: <a className="text-cyan-600 hover:underline" href="mailto:aaryan_bairagi_it@mcoe.edu.in">aaryan_bairagi_it@mcoe.edu.in</a>) is here to help you with any questions or issues related to ModNect. Fill out the form below or reach out directly using the contact information.
      </p>
