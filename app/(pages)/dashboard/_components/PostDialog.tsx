...
//       if (file) {
//         uploadedImageUrl = await uploadFileToCloudinary(file);
//         setImageUrl(uploadedImageUrl); // Optional, in case needed later
//       }
...
//             <input type="file" id="post-file-upload" name="file" className="hidden" onChange={handleFileChange} disabled={loading} />
