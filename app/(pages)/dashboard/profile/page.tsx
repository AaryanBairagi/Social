...
export default function UserProfilePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto my-12">
      {/* Profile Card */}
      <div className="bg-white shadow-md rounded-xl p-8 border border-gray-100 mb-8 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-gray-500">@{clerkUser?.username}</p>
          </div>
        </div>
        ...
        <Button
          onClick={() => signOut()}
          className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-full shadow text-white"
        >
          Sign Out
        </Button>
      </div>
      ...
      <div className="bg-white shadow-md rounded-xl p-8 border border-gray-100">
        <h3 className="text-xl font-semibold mb-4 text-cyan-600">Edit Profile</h3>
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-cyan-400 focus:outline-none"
            rows={3}
